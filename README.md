...
- Node.js 18+
- libheif 1.17+
    - 用于 HEIF 格式支持。如果您的发行版打包版本太旧，不满足要求，则需要使用项目内构建版本，具体见下段的命令示例。[libheif 文档](https://github.com/strukturag/libheif)
- FFmpeg（用于视频缩略图生成）
...
# 注意！libheif还依赖其他库，您可能需要另行安装这些库以及处理相关特性开关。一个简单的方法是同时安装系统依赖库，这样系统会自行处理必要的依赖
